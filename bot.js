...
client.login('NTIxMzE0OTg0NDg0MTQzMTA0.DvUP8A.prUV31xF7__C3cIDT-nDXTc3YhM'); 
            ...
            message.channel.sendEmbed(embedx);
                                 ...
                                 client.on('message' , message => {
                                    ...
                                    client.on('message', message => { 
                                        ...
                                        .setFooter(`gamers bot.`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
                       ...
                       client.on("message", message => {
                             ...
                             client.on('message', message => {
    if (message.content.startsWith("$image1")) { // الامر
     ...
     .setColor('RANDOM')
     .setImage('https://cdn.pg.sa/JlLQldFkQL.png') // رابط الصورة
      message.channel.sendEmbed(LastCode);
     }
   });

client.on('message', message => {
    if (message.content.startsWith("$image2")) { // الامر
                                    var mentionned = message.mentions.users.first();
                var mentionavatar;
                  if(mentionned){
                      var mentionavatar = mentionned;
     ...
     var LastCode = new Discord.RichEmbed()
     .setColor('RANDOM')
     .setImage('https://cdn.pg.sa/YLYztO467k.jpg') // رابط الصورة
      message.channel.sendEmbed(LastCode);
     }
   });   
